...
- 首页：今日一句话、今日 Action、今日变化、市场温度、参与统计股票数、数据口径、今日最强主线、最近 10 日主线趋势、可研究候选/等待回调/高位观察不追/回避四栏股票池。
- 市场温度：上涨下跌家数、涨跌停估算、成交额、主要指数与涨跌幅分布。
- 主线雷达：行业板块、概念板块、短线情绪标签分层展示；情绪标签不参与主线排名。
- 龙头股票池：代表性股票池、K线、均线、成交额、趋势状态、观察状态、价格校验和失效条件；同一股票按代码去重，多主线合并显示，并拆分为“可研究候选”“等待回调”“高位观察/不追”“回避”。
